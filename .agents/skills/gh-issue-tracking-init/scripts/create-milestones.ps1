...
.DESCRIPTION
    ...
    self-contained). Source of truth / general-purpose original: scripts/create-milestones.ps1
...
.EXAMPLE
    ...
    ./.agents/skills/gh-issue-tracking-init/scripts/create-milestones.ps1 -Repo "owner/repo" -Titles "Phase 1","Phase 2"

.EXAMPLE
    # Create milestones from a file and preview actions
    ./.agents/skills/gh-issue-tracking-init/scripts/create-milestones.ps1 -Repo "owner/repo" -TitlesFile "./milestones.txt" -DryRun
