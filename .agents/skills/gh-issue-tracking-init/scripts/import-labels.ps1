...
.DESCRIPTION
    ...
    Vendored copy for the gh-issue-tracking-init skill (keeps the skill
    self-contained). Source of truth / general-purpose original: scripts/import-labels.ps1
...
.EXAMPLE
    # Preview changes
    ./.agents/skills/gh-issue-tracking-init/scripts/import-labels.ps1 -Repo "owner/target-repo" -LabelsFile "./.labels.json" -DryRun

.EXAMPLE
    # Apply changes (create/update)
    ./.agents/skills/gh-issue-tracking-init/scripts/import-labels.ps1 -Repo "owner/target-repo" -LabelsFile "./.labels.json"

.EXAMPLE
    # Apply changes and delete labels not in the file
    ./.agents/skills/gh-issue-tracking-init/scripts/import-labels.ps1 -Repo "owner/target-repo" -DeleteMissing
